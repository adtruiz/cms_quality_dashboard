                ...
                <div className="space-y-4">
                  <div className="relative h-80">
                    <svg className="w-full h-full" viewBox="0 0 800 360" preserveAspectRatio="xMidYMid meet">
                      {/* Grid lines - N/A, 0-5 stars */}
                      {/* Not Available line (at bottom) */}
                      <g>
                        <line
                          x1="50"
                          y1={290}
                          ...
                          strokeWidth="1"
                        />
                        <text x="10" y={295} fill="#9ca3af" fontSize="11" textAnchor="start">
                          N/A
                        </text>
                      </g>

                      {/* Star rating lines (0-5) */}
                      {[0, 1, 2, 3, 4, 5].map((val) => {
                        const y = 260 - (val / 5) * 210;
                        return (
                          <g key={val}>
                            <line
                              x1="50"
                      ...
                      <path
                        d={(() => {
                          ...
                          return data.map((point, idx) => {
                            ...
                            // If rating is null, plot at "Not Available" level (y=290)
                            // Otherwise plot at star level (0-5)
                            const y = (point.overall_rating === null)
                              ? 290
                              : 260 - (point.overall_rating / 5) * 210;
                      ...
                      {historicalData.slice(-10).map((point, idx) => {
                        ...
                        // If rating is null, plot at "Not Available" level
                        // Otherwise plot at star level (0-5)
                        const y = (point.overall_rating === null)
                          ? 290
                          : 260 - (point.overall_rating / 5) * 210;
                        return (
                          <g key={idx}>
                            ...
                            <text x={x} y={310} fill="#9ca3af" fontSize="12" textAnchor="middle">
